<div class="flex space-x-1 justify-around">
    <a href="{{ route('lugares', [$nombre]) }}" target="_blank" class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded">
    ...
    <a href="{{ route('lugares', [$id]) }}" target="_blank" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
